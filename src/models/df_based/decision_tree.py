...
if __name__ == '__main__':
    ...
    for fold in range(len(splits)):
        ...
        tr_df, te_df, mean_vals, std_vals, min_vals, max_vals = RR_utils.split_data(df, splits[fold], cfg.class_label,
                                                                                    cfg.standardized, cfg.rescaled)
        print(tr_df)
        ...
        for dataset in l:
            ...
            plot_pca.plot(df, features=list(tree_features), norm=cfg.standardized, rescale=cfg.rescaled,
                          class_label=cfg.class_label, colors=cfg.class_colors,
                          file_name='{}tree/{}_{}_{}.png'.format(out_fold, fold + 1, dataset[1], cfg.viz_method),
                          method=cfg.viz_method, task=cfg.task, perplexity=cfg.perplexity, n_iter=cfg.n_iter)
